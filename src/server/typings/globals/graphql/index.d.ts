...
// Source: https://raw.githubusercontent.com/DefinitelyTyped/DefinitelyTyped/05e9c858cf55270a48b1234e613fa9b26da8be23/graphql/index.d.ts
...
declare module 'graphql/language/parser' {
    import { DocumentNode, NamedTypeNode, TypeNode, ValueNode } from 'graphql/language/ast';
...
declare module 'graphql/type/definition' {
    ...
    class GraphQLObjectType {
        public name: string;
        public description: string;
        public isTypeOf: GraphQLIsTypeOfFn<any, any>;

        constructor(config: GraphQLObjectTypeConfig<any, any>);
        public getFields(): GraphQLFieldMap<any, any>;
    ...
    class GraphQLInterfaceType {
        public name: string;
        public description: string;
        public resolveType: GraphQLTypeResolver<any, any>;
    ...
    class GraphQLUnionType {
        ...
        public getTypes(): GraphQLObjectType[];
    ...
    class GraphQLEnumType {
        ...
        public getValues(): GraphQLEnumValue[];
    ...
    class GraphQLInputObjectType {
        ...
        public getFields(): GraphQLInputFieldMap;
        public toString(): string;
    }
...
declare module 'graphql/type/directives' {
    ...
    class GraphQLDirective {
        public name: string;
        public description: string;
        public locations: DirectiveLocationEnum[];
        public args: GraphQLArgument[];
...
declare module 'graphql/type/schema' {
    ...
    class GraphQLSchema {
        ...
        public getQueryType(): GraphQLObjectType;
        public getMutationType(): GraphQLObjectType;
        public getSubscriptionType(): GraphQLObjectType;
        public getTypeMap(): GraphQLNamedType;
        public getType(name: string): GraphQLType;
        public getPossibleTypes(abstractType: GraphQLAbstractType): GraphQLObjectType[];

        public isPossibleType(
...
declare module 'graphql/validation/validate' {
    ...
    export class ValidationContext {
        ...
        public reportError(error: GraphQLError): void;
        ...
        public getFragment(name: string): FragmentDefinitionNode;

        public getFragmentSpreads(node: SelectionSetNode): FragmentSpreadNode[];

        public getRecursivelyReferencedFragments(
            operation: OperationDefinitionNode,
        ): FragmentDefinitionNode[];

        public getVariableUsages(node: NodeWithSelectionSet): VariableUsage[];
        ...
        public getParentType(): GraphQLCompositeType;

        public getInputType(): GraphQLInputType;

        public getFieldDef(): GraphQLField<any, any>;

        public getDirective(): GraphQLDirective;

        public getArgument(): GraphQLArgument;
    }
...
declare module 'graphql/execution/values' {
        import { DirectiveNode, FieldNode, VariableDefinitionNode } from 'graphql/language/ast';
import { GraphQLArgument, GraphQLField, GraphQLInputType } from 'graphql/type/definition';
    import { GraphQLDirective } from 'graphql/type/directives';
    import { GraphQLSchema } from 'graphql/type/schema';
    /**
...
declare module 'graphql/error/GraphQLError' {
    ...
    class GraphQLError extends Error {
         ...
         * Enumerable, and appears in the result of JSON.stringify().
         */
        public locations?: Array<{ line: number, column: number }> | void;
         ...
         * Enumerable, and appears in the result of JSON.stringify().
         */
        public path?: Array<string | number> | void;

        /**
         * An array of GraphQL AST Nodes corresponding to this error.
         */
        public nodes?: ASTNode[] | void;

        /**
         * The source GraphQL document corresponding to this error.
         */
        public source?: Source | void;

        /**
         * An array of character offsets within the source GraphQL document
         * which correspond to this error.
         */
        public positions?: number[] | void;
...
declare module 'graphql/utilities/concatAST' {
     ...
     */
    function concatAST(asts: DocumentNode[]): DocumentNode;
}
...
declare module 'graphql/utilities/typeFromAST' {
    ...
    import { GraphQLNullableType, GraphQLType } from 'graphql/type/definition';
    import { GraphQLSchema } from 'graphql/type/schema';
...
import { GraphQLSchema } from 'graphql/type/schema';
    ...
    class TypeInfo {
        ...
        public getDirective(): GraphQLDirective;
        public getArgument(): GraphQLArgument;
        public enter(node: ASTNode): any;
        public leave(node: ASTNode): any;
    }
